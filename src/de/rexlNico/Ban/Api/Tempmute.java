...
public class Tempmute
{
    public static boolean playerExists(final String uuid) {
        ResultSet rs = null;
        try {
            rs = main.mysql.query("SELECT * FROM Tempmute WHERE UUID= '" + uuid + "'");
            if (rs.next()) {
    ...
    public static void unban(final String Spielername, final Integer banned) {
        main.mysql.update("UPDATE Tempmute SET BANNED= '" + banned + "' WHERE UUID= '" + Spielername + "';");
        main.mysql.update("DELETE FROM HistoryMute WHERE UUID= '" + Spielername + "'");
    }
    ...
    public static Integer getTempBanned(final String name) {
        ...
        try {
            ...
            try {
                rs = main.mysql.query("SELECT * FROM Tempmute WHERE UUID= '" + name + "'");
    ...
    public static Long getEnd2(final String Spielername) {
        ...
        if (playerExists(Spielername)) {
            rs = main.mysql.query("SELECT * FROM HistoryMute WHERE UUID= '" + Spielername + "'");
            try {
                if (rs.next()) {
    ...
    public static Long getEnd(final String Spielername) {
        ResultSet rs = null;
        if (playerExists(Spielername)) {
            rs = main.mysql.query("SELECT * FROM Tempmute WHERE UUID= '" + Spielername + "'");
            try {
                if (rs.next()) {
    ...
    public static void setTempmute(final String Spielername, final String Grund, final long length, final String ip, final Integer points) {
        ...
        main.mysql.update("INSERT INTO HistoryMute(UUID,Datum,Uhrzeit,Grund,Length) VALUES ('" + Spielername + "','" + dateString + "', '" + uhrzeit + "','" + Grund + "','" + length + "');");
        main.mysql.update("INSERT INTO Tempmute(UUID,End,Reason,VON,POINTS,BANNED) VALUES ('" + Spielername + "','" + ende + "','" + Grund.toUpperCase() + "','" + ip + "','" + points + "', '1')");
    }
    
    public static void setTempmute2(final String Spielername, final String Grund, final long length, final String ip, final Integer points, final Integer banned) {
        final long c = System.currentTimeMillis();
        final long millis = length * 1000L;
        final long ende = c + millis;
        final Date date = Calendar.getInstance().getTime();
        ...
        final String uhrzeit = sdf.format(new Date());
        main.mysql.update("INSERT INTO HistoryMute(UUID,Datum,Uhrzeit,Grund,Length) VALUES ('" + Spielername + "','" + dateString + "', '" + uhrzeit + "','" + Grund + "','" + length + "');");
        main.mysql.update("UPDATE Tempmute SET UUID= '" + Spielername + "' WHERE UUID= '" + Spielername + "';");
        main.mysql.update("UPDATE Tempmute SET POINTS= '" + points + "' WHERE UUID= '" + Spielername + "';");
        main.mysql.update("UPDATE Tempmute SET BANNED= '" + banned + "' WHERE UUID= '" + Spielername + "';");
        main.mysql.update("UPDATE Tempmute SET IP= '" + ip + "' WHERE UUID= '" + Spielername + "';");
        main.mysql.update("UPDATE Tempmute SET Reason= '" + Grund + "' WHERE UUID= '" + Spielername + "';");
        main.mysql.update("UPDATE Tempmute SET End= '" + ende + "' WHERE UUID= '" + Spielername + "';");
    }
